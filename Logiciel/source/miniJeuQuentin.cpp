...
{
    cercle.setRadius(50);
    cercle.setPosition(app.window.getView().getSize().x/2 - cercle.getRadius(),app.window.getView().getSize().y/2 - cercle.getRadius());
...
void miniJeuQ::update()
{
    ...
    if (cercle.getPosition().y<0 || cercle.getPosition().y>app.window.getView().getSize().y-cercle.getRadius()*2)
    {
        app.score+=1;
        isFinished=true;
    }
    if (cercle.getPosition().x<0 || cercle.getPosition().x>app.window.getView().getSize().x-cercle.getRadius()*2)
    {
        app.score+=1;
        isFinished=true;
    }
