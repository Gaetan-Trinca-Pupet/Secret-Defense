...
CorrectTheCode::CorrectTheCode(AppData &appdata) : MiniJeu(appdata), maxTime((6+4*std::min(int(app.difficulty), 5))* pow(0.95, std::max(int(app.difficulty)-5, 0) )), chrono(app.window)
{
